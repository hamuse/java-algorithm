...
public class Student { // 12개 메소드 만들어서 Engine 에 나오게 하기
	  ...
	  public String getTimeCalc(int time) {
	    ...
	    public String getPassOrFail(String[] subject,int[] score) {
			...
			subject[6] = result;
			String resurt =String.format("%s, %d점, %d점, %d점, 총점 %s점, 평균 %s점, %s", subject[0], score[0], score[1], score[2], subject[4],
					subject[5], subject[6]);
			return resurt;
	    }
	    ...
	    public String getScoreCalc(int scnNum,int ans[],int array[],int count) {
	        int sum = 0;
	        int ave = 0;
	        String shape = "";
	        String numbersText = "";
